export const DTO_NAME_SUFFIX = 'Dto';
export const LOGIN_DTO_NAME_SUFFIX = 'LoginDto';
export const CREATE_DTO_NAME_SUFFIX = 'CreateDto';
export const UPDATE_DTO_NAME_SUFFIX = 'UpdateDto';

export const ENTRY_NAME_SUFFIX = 'Entry';
